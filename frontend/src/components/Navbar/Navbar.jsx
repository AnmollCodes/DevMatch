            ...
            <nav>
                <div>
                    <h1 className='text-4xl font-Fira text-white1 px-4 py-4 float-left hover:text-green1'>
                        <Link to='/home'>&lt;DevMatch&gt;</Link></h1>
                    <div className='text-sm font-Poppins font-light text-white1 float-right px-6 py-7'>
                        <span className='px-6 hover-underline-animation'><a href="https://devmatch.streamlit.app/" target="_blank" rel="noopener noreferrer">Resume Parser</a></span>
                        ...
                        <span className='pl-6 pr-4 hover-underline-animation'><NavLink to='/about'>about DevMatch</NavLink></span>
                    </div>
                </div>
            </nav>
        </>
